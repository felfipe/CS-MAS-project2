...
class TestModel(Model):
    """TestModel which inherit from Model
    to test CommunicatingAgent and MessageService."""
...
if __name__ == "__main__":
    ...
    assert isinstance(agent0, CommunicatingAgent)
    assert isinstance(agent1, CommunicatingAgent)
